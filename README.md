### This is a Basic Home Page for Men Shoes If Add to Cart is Clicked cart button adds the count and button name changes to remove from cart if remove is clicked cart count decreases
